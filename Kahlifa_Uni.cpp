...
using namespace std;
int main(){
    ofstream Data;ofstream Data2;
double revenue[100], busy[100],plate_no[100],spaces[100],hour_rate[100];
int choice, sub_choice,ID_del,ID_search,sum,IDD;
string username[100],password[100],user_del,user_search,pass_search;
int i=0;int j=-1,ii,jj,nn,ff=0,jmax=0,flag=0,ID[100][100],cc=0,TOKEN[100],pp=0,P_ID,hrs,plate_search;
...
while(1){
  ...
  case 2:
    for(ii=0;ii<100;ii++){
    for(cc=0;cc<100;cc++)
    if(ID[99][ii]==ID[IDD][cc]&&ID[IDD][cc]!=0){
